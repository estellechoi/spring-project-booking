...
public class ProductDaoSqls {
	...
	public static final String SELECT_COUNT_BY_CATEGORY = "SELECT count(product.id) FROM product, category WHERE category.name = :categoryName AND product.category_id = category.id";
